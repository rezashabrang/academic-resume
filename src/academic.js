              ...
              <div className="col-sm-6">
                <div className="single-about-txt">
                  <p className='font-weight-bold text-justify'>
                    <b>I have graduated from Amir Kabir university of technology with a QS ranking of 443 on year 2021. My bachelor thesis is a machine learning project about predicting construction project costs which I have passed with a grade of 4/4 (Details can be found below).<br></br>Also, I am currently working as a Data Scientist in the medical data and Natural Language Processing (NLP) fields.<br></br>I am very enthusiastic about learning, and I always try to be up to date with state of the art machine learning models and problems like meta-learning, image processing, GANs, Transformers, etc. <br></br>Currently, I am looking for a graduate position in Computer Science or Industrial & System Engineering Major to research in data science and machine learning field.</b>
                  </p>
                  <div className="row">
                    <div className="col-sm-6">
